...
const AddProject = () => {
  ...
  useEffect(() => {
    if (mutation.isError) {
      toast.error(mutation.error.response, {
        position: "top-right",
        autoClose: 5000,
        theme: "dark",
        style: { width: "100%" },
              ...
              <div className="flex flex-col gap-1 w-full">
                ...
                <div className="flex flex-col">
                  ...
                  >
                    ...
                    <label
                      htmlFor="projectVideo"
                      className="w-[70%] cursor-pointer lg:py-[0.8vw] whitespace-nowrap px-[1.1vw] md:py-[1.8vw] xs:py-[2.6vw] bg-gray-200"
                    >
                      {projectVideo ? projectVideo.name : "No file choosen"}
                    </label>
                  </label>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-1 w-full">
              ...
              <div className="flex flex-col">
                ...
                >
                  ...
                  <label
                    htmlFor="projectPoster"
                    className="w-[80%] cursor-pointer lg:py-[0.8vw] whitespace-nowrap px-[1.1vw] md:py-[1.8vw] xs:py-[2.6vw] bg-gray-200"
                  >
                    {projectPoster ? projectPoster.name : "No file choosen"}
                  </label>
                </label>
              </div>
            </div>
