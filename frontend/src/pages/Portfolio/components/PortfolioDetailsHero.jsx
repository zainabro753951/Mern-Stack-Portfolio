...
const PortfolioDetailsHero = ({ projectName, poster }) => {
  ...
  return (
    ...
    >
      <div className="md:max-w-[80vw] md:h-[120vh] relative xs:h-[35vh] mx-auto flex flex-col items-center xs:justify-center md:justify-normal">
        <div className="md:gap-[1.3vw] xs:gap-[2.3vw] w-full md:pt-[13vw] flex items-center flex-col ">
          <h2
            ...
            className="md:text-[4vw] sm:text-[4.5vw] xs:text-[5vw] md:leading-[4.5vw] sm:leading-[5.5vw] xs:leading-[6.5vw] font-bold font-lexend_deca"
          >
            {projectName}
          </h2>
