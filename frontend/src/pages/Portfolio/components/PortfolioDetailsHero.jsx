...
const PortfolioDetailsHero = ({ projectName }) => {
  ...
  return (
    ...
    >
      <div className="md:max-w-[80vw] md:h-[120vh] xs:h-[50vh] mx-auto flex flex-col items-center md:gap-[1.3vw] xs:gap-[2.3vw] justify-center">
        <h2
          id="blueGardient"
          style={{ willChange: "scale, transform, opacity" }}
          className="md:text-[4vw] xs:text-[5.5vw] md:leading-[4.5vw] xs:leading-[6.5vw]  font-bold font-lexend_deca"
        >
          {projectName}
        </h2>
