...
const AboutUs = () => {
  ...
  return (
    <div className="w-full bg-[#F9FBFF]">
      <div className="max-w-[1200px] mx-auto min-h-screen py-20 px-5 place-items-center grid lg:grid-cols-2 gap-32 place-content-center items-center">
        <div>
          <div className="flex items-center gap-3 pb-2">
            <h1 className="text-lg text-themeBlue font-jost">About Me</h1>
            <div id="rotateAbout">
              <svg
                width="34"
                height="18"
          ...
          <h2 className="text-5xl font-semibold leading-[55px] font-lexend_deca">
            Why you <span className="text-themePurple">hire me</span> for your{" "}
            <span className="text-themeBlue">next project?</span>
          </h2>
          <p className="py-8 text-gray-500 text-lg font-jost tracking-wide leading-7">
          ...
          {cardData.map((data, idx) => {
            return (
              <div
                key={idx}
                id="aboutCard"
                className="flex items-center gap-4 transition-all duration-500 bg-white rounded-xl border-b-2 border-gray-200 border-r border-l p-5"
              >
                <div className="p-5">
                  <img className="w-[50px]" src={data.icon} alt="" />
                </div>
                <div className="flex flex-col gap-5">
                  <div>
                    <h1
                      id="aboutName"
                      className="text-3xl font-lexend_deca text-themeBlue font-medium transition-all duration-700"
                    >
                      {data.name}
                    </h1>
                    <p className="text-lg text-gray-500 font-jost tracking-wide">
                      {data.disc}
                    </p>
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      id="icon"
                      className="p-3 duration-1000 rounded-full border border-gray-400"
                    >
                      <svg
                        width="11"
                        height="11"
