let icons = [
  <svg
    viewBox="0 0 13 22"
    className="lg:w-[1.1vw] icon md:w-[2.1vw] xs:w-[3.5vw]"
    fill="none"
  ...
  <svg
    className="icon lg:w-[1.7vw] md:w-[2.7vw] xs:w-[4.3vw]"
    viewBox="0 0 22 24"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
  >
  ...
  <svg
    className="icon lg:w-[2vw] md:w-[3vw] xs:w-[3.5vw]"
    viewBox="0 0 25 18"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
  >
...
const Hero = ({ content }) => {
  ...
  return (
    <div ref={targetSection} className="w-full bg-hero bg-cover bg-no-repeat">
