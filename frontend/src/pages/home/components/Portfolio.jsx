...
const Portfolio = () => {
  return (
    <div className="w-full bg-portfolio bg-cover bg-no-repeat">
      <div className="w-full max-w-[1200px] min-h-screen mx-auto px-5 py-32 grid lg:grid-cols-2 gap-20 font-jost">
        <div className="w-full h-full">
          ...
          <h2 className="text-5xl font-semibold pt-4 tracking-wide">
            My latest <br /> awasome{" "}
            <span className="text-themePurple">projects</span>
          </h2>
          <div
            id="ProjectHovers"
            className="flex flex-col rounded-3xl overflow-hidden mt-24 relative"
          >
            <div className="p-5 flex items-center gap-10 portfolioGardient">
            ...
            >
              <h2 className="text-3xl font-semibold">First Project</h2>
          ...
          <div className="py-8 text-center xs:hidden lg:block text-2xl font-semibold text-themePurple">
        ...
        <div className="w-full h-full flex flex-col">
          ...
          >
            ...
            <div
              ...
              className="absolute transition-all duration-300 left-0 bottom-0 translate-y-full flex flex-col gap-1 p-6 bg-themeBlue/50 text-white w-full"
            >
              <h2 className="text-3xl font-semibold">Second Project</h2>
              <div className="flex items-center gap-2">
                <h3 id="viewWork" className="text-xl relative">
                  View Work
                </h3>
          ...
          >
            ...
            <div
              ...
              className="absolute transition-all duration-300 left-0 bottom-0 translate-y-full flex flex-col gap-1 p-6 bg-themeBlue/50 text-white w-full"
            >
              <h2 className="text-3xl font-semibold">Third Project</h2>
              <div className="flex items-center gap-2">
                <h3 id="viewWork" className="text-xl relative">
                  View Work
                </h3>
        ...
        <div className="py-8 text-center text-2xl font-semibold text-themePurple">
          <Link id="viewProject" className="relative">
            {" "}
            View All Project{" "}
          </Link>
