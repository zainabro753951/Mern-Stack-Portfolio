    ...
    <div className="bg-aboutEducation bg-cover bg-no-repeat overflow-hidden">
      <div className="max-w-[1200px] mx-auto md:py-[8vw] xs:py-[13vw] px-5 ">
        <div className="w-full flex justify-between items-end">
          <div className="overflow-hidden">
            <h2
              ...
              className="md:text-[3.2vw] xs:text-[4.2vw] font-semibold md:leading-[3.6vw] xs:leading-[4.6vw] font-lexend_deca "
            >
          ...
          <Link
            className="md:text-[1.6vw] xs:text-[2.6vw] font-lexend_deca font-semibold text-themePurple relative"
            id="viewProject"
          >
            Hire Me
          </Link>
        ...
        <div className="w-full md:pt-[1.5vw] xs:pt-[2.5vw] grid md:grid-cols-2 xs:grid-cols-1">
          {isLoading ? (
            <div>
              <h2 className="md:text-[2.1vw] xs:text-[3.1vw] font-semibold font-lexend_deca md:py-[1.3vw] xs:my-[2.3vw]">
                Education
              </h2>
            ...
            <div>
              <h2 className="md:text-[2.1vw] xs:text-[3.1vw] font-semibold font-lexend_deca md:py-[1.3vw] xs:py-[2.3vw]">
                Education
              </h2>
              <div className="flex flex-col md:gap-[4vw] xs:gap-[5vw] pt-4">
                {educationData?.map((data, idx) => {
                  ...
                  return (
                    ...
                    >
                      <div>
                        <div className="md:p-[1vw] xs:p-[2vw] rounded-full eduGardient border-r border-b border-gray-300">
                          <svg
                            viewBox="0 0 37 32"
                            fill="none"
                            className="fill-themeBlue md:w-[2.2vw] xs:w-[3.2vw] "
                      ...
                      <div>
                        <h4 className="md:text-[1.3vw] xs:text-[2.3vw]  md:leading-[1.9vw] xs:leading-[2.9vw] text-gray-500 font-jost">
                          {data.instituteName}
                        </h4>
                        <h3 className="md:text-[1.5vw] xs:text-[2.5vw]  font-semibold font-lexend_deca">
          ...
          <div>
            <h2 className="md:text-[2.1vw] xs:text-[3.1vw] font-semibold font-lexend_deca py-5">
              Skills
            </h2>
            <div className="flex flex-col md:gap-[4vw] xs:gap-[5vw] pt-4">
              <div
              ...
              >
                <div className="flex justify-between items-center">
                  <h3 className="md:text-[1.3vw] xs:text-[2.3vw] md:leading-[1.9vw] xs:leading-[2.9vw] font-semibold font-lexend_deca">
                    Communication
                  </h3>
                  <p className="md:text-[1.3vw] xs:text-[2.3vw] md:leading-[1.9vw] xs:leading-[2.9vw] font-jost text-gray-500">
                    90%
                  </p>
                </div>
                <div className="w-full md:md:h-[0.5vw] xs:h-[1vw] rounded-full overflow-hidden bg-gray-300">
              ...
              >
                ...
                <div className="w-full md:h-[0.5vw] xs:h-[1vw] rounded-full overflow-hidden bg-gray-300">
                  <div className="h-full w-[90%] bg-themeBlue rounded-full"></div>
                </div>
              </div>
              <div
